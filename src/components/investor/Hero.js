    ...
    return (
        <section className="hero">
            ...
            <div className="hero__copy">
                <p id="name">Investor Academy</p>
                <h1>Investing by us <br/> for us.</h1>
                <p>
                The Academy is built to foster equitable capital pathways by sourcing potential Black investors to learn cutting-edge insights and practical tips to navigate early stage investments and fund building.
                </p>
                <h3>
                    Application deadline <br/> <span className="hero__copy__dates">TBA</span> 
                </h3>
                <h3>
                Program Start <br/> <span className="hero__copy__dates">Q3 2021</span> 
                </h3>
